function getActMyoDataIX(position,rawdir,datadir,jitter)
...
for frameNum=1:length(imRatio_raw)
 ...
 save([datadir,filesep,position,'_RatioData_raw.mat'],'-v7.3','maskFinal','cellCoors','imRatio_raw','imRFPOutline');
 save([datadir,filesep,position,'_Bleach_raw.mat'],'-v7.3','bleach_raw');
