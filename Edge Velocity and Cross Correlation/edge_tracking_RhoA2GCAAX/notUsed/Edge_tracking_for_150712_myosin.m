...
clear; close all; clc;
datadir='K:\data\150120_IX\CDH5-CIT-FT-CY-P2A-TQ-MYL9-30s\data_150713';
position='3_2_1';
...
edgeDepthDist=5;                                   % Number of pixels deep for the windows for computing FRET values.
...
%% Save data
save([datadir,filesep,position,'_Cell',num2str(selectedCell),'_edgetracking.mat'],'protvalsWindow','fretvals','protvalsWindowF','fretvalsF');
