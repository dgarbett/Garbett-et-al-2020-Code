function [tracedata,curdatatracked,tracking,nuc_label]=adaptivetrack_membrane(lastgoodframe,curframe,tracedata,curdata,tracking,nuc_raw,nuc_label,nucr,jitter,winrad,H2BvsNLS)
...
%find number of cells in last frame
...
splitid=find(borderflag);%empty array
mergemaskorg=ismember(nuc_label,splitid);
mergemask=mergemaskorg & ~bordermask; %same as mergemaskorg
